# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-21 20:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cropped', image_cropping.fields.ImageRatioField('image', '1110x624', adapt_rotation=False, allow_fullsize=False, free_crop=False, help_text=None, hide_image_field=False, size_warning=False, verbose_name='cropped')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nav_icon', models.CharField(blank=True, choices=[('twitter', 'Twitter'), ('facebook', 'Facebook'), ('instagram', 'Instagram'), ('linkedin', 'LinkedIn')], max_length=200, null=True, verbose_name='Navigation Icon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.CharField(blank=True, choices=[('ContactForm', 'Contact Form'), ('FosteringForm', 'Fostering Form')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('node_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pages.node')),
                ('social', models.CharField(choices=[('twitter', 'Twitter'), ('facebook', 'Facebook'), ('instagram', 'Instagram'), ('linkedin', 'LinkedIn')], max_length=200, verbose_name='Social Type')),
            ],
            options={
